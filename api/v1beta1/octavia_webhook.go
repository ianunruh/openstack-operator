...
func (r *Octavia) Default() {
	...
	r.Spec.HealthManager.InitDHCPImage = imageDefault(r.Spec.HealthManager.InitDHCPImage, DefaultOVSSwitchImage)
	r.Spec.HealthManager.InitOVSImage = imageDefault(r.Spec.HealthManager.InitOVSImage, DefaultOctaviaHealthManagerInitDHCPImage)
