...
//+kubebuilder:webhook:path=/mutate-openstack-k8s-ianunruh-com-v1beta1-octavia,mutating=true,failurePolicy=fail,sideEffects=None,groups=openstack.k8s.ianunruh.com,resources=octavias,verbs=create;update,versions=v1beta1,name=moctavia.kb.io,admissionReviewVersions={v1,v1beta1}
...
//+kubebuilder:webhook:path=/validate-openstack-k8s-ianunruh-com-v1beta1-octavia,mutating=false,failurePolicy=fail,sideEffects=None,groups=openstack.k8s.ianunruh.com,resources=octavias,verbs=create;update,versions=v1beta1,name=voctavia.kb.io,admissionReviewVersions={v1,v1beta1}
