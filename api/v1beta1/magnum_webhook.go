...
//+kubebuilder:webhook:path=/mutate-openstack-ospk8s-com-v1beta1-magnum,mutating=true,failurePolicy=fail,sideEffects=None,groups=openstack.ospk8s.com,resources=magnums,verbs=create;update,versions=v1beta1,name=mmagnum.kb.io,admissionReviewVersions={v1,v1beta1}
...
func (r *Magnum) Default() {
	...
	r.Spec.Image = imageDefault(r.Spec.Image, MagnumDefaultImage)
}

// TODO(user): change verbs to "verbs=create;update;delete" if you want to enable deletion validation.
//+kubebuilder:webhook:path=/validate-openstack-ospk8s-com-v1beta1-magnum,mutating=false,failurePolicy=fail,sideEffects=None,groups=openstack.ospk8s.com,resources=magnums,verbs=create;update,versions=v1beta1,name=vmagnum.kb.io,admissionReviewVersions={v1,v1beta1}
