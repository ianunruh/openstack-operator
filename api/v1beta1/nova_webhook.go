...
//+kubebuilder:webhook:path=/mutate-openstack-k8s-ianunruh-com-v1beta1-nova,mutating=true,failurePolicy=fail,sideEffects=None,groups=openstack.k8s.ianunruh.com,resources=novas,verbs=create;update,versions=v1beta1,name=mnova.kb.io,admissionReviewVersions={v1,v1beta1}
...
//+kubebuilder:webhook:path=/validate-openstack-k8s-ianunruh-com-v1beta1-nova,mutating=false,failurePolicy=fail,sideEffects=None,groups=openstack.k8s.ianunruh.com,resources=novas,verbs=create;update,versions=v1beta1,name=vnova.kb.io,admissionReviewVersions={v1,v1beta1}
