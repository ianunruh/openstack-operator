...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NovaCellComputeSpec) DeepCopyInto(out *NovaCellComputeSpec) {
	*out = *in
	if in.NodeSelector != nil {
		in, out := &in.NodeSelector, &out.NodeSelector
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NovaCellComputeSpec.
func (in *NovaCellComputeSpec) DeepCopy() *NovaCellComputeSpec {
	if in == nil {
		return nil
	}
	out := new(NovaCellComputeSpec)
	in.DeepCopyInto(out)
	return out
}
