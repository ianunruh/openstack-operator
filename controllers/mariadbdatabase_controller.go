...
// +kubebuilder:rbac:groups=openstack.ospk8s.com,resources=mariadbdatabases/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=openstack.ospk8s.com,resources=mariadbdatabases/finalizers,verbs=update
