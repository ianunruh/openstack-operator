...
func PKIResources(instance *openstackv1beta1.Magnum) []*unstructured.Unstructured {
...
func APICertificate(instance *openstackv1beta1.Magnum) *unstructured.Unstructured {
