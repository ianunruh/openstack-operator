...
func NewReporter(instance *openstackv1beta1.Magnum, k8sClient client.Client, recorder record.EventRecorder) *Reporter {
	return &Reporter{
...
func (r *Reporter) Running(ctx context.Context) error {
	return r.reporter.UpdateReadyCondition(ctx, metav1.ConditionTrue, openstackv1beta1.ReasonRunning, "Magnum is running")
}

func AddReadyCheck(cw *template.ConditionWaiter, instance *openstackv1beta1.Magnum) {
