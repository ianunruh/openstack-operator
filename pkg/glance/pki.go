...
func PKIResources(instance *openstackv1beta1.Glance) []*unstructured.Unstructured {
...
func APICertificate(instance *openstackv1beta1.Glance) *unstructured.Unstructured {
