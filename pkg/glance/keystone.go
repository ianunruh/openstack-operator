...
func KeystoneService(instance *openstackv1beta1.Glance) *openstackv1beta1.KeystoneService {
...
func KeystoneUser(instance *openstackv1beta1.Glance) *openstackv1beta1.KeystoneUser {
	labels := template.AppLabels(instance.Name, AppLabel)
