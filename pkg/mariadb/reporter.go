...
const (
	PendingReason = "MariaDBPending"
	RunningReason = "MariaDBRunning"
)

func NewReporter(instance *openstackv1beta1.MariaDB, k8sClient client.Client, recorder record.EventRecorder) *Reporter {
	return &Reporter{
...
func (r *Reporter) Running(ctx context.Context) error {
	return r.reporter.UpdateReadyCondition(ctx, metav1.ConditionTrue, RunningReason, "MariaDB is running")
}
