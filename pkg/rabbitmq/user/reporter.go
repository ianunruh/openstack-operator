...
const (
	readyMessage = "User in RabbitMQ reconciled successfully"
)
...
func (r *Reporter) Pending(instance *openstackv1beta1.RabbitMQUser, err error, eventReason, message string) {
	if err != nil {
...
func (r *Reporter) Succeeded(instance *openstackv1beta1.RabbitMQUser) {
	r.recorder.Event(instance, corev1.EventTypeNormal, "RabbitMQUserReconciled", readyMessage)
	SetCondition(instance, openstackv1beta1.ConditionReady,
		metav1.ConditionTrue, openstackv1beta1.ReasonSucceeded, readyMessage)
}

func ReadyCondition(instance *openstackv1beta1.RabbitMQUser) *metav1.Condition {
	return meta.FindStatusCondition(instance.Status.Conditions, openstackv1beta1.ConditionReady)
}

func SetCondition(instance *openstackv1beta1.RabbitMQUser, conditionType string, status metav1.ConditionStatus, reason, message string) {
