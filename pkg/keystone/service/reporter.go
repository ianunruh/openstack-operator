...
const (
	readyMessage = "Service in Keystone reconciled successfully"
)
...
func (r *Reporter) Pending(instance *openstackv1beta1.KeystoneService, err error, eventReason, message string) {
	if err != nil {
...
func (r *Reporter) Succeeded(instance *openstackv1beta1.KeystoneService) {
	r.recorder.Event(instance, corev1.EventTypeNormal, "KeystoneServiceReconciled", readyMessage)
	SetCondition(instance, openstackv1beta1.ConditionReady,
		metav1.ConditionTrue, openstackv1beta1.ReasonSucceeded, readyMessage)
}

func ReadyCondition(instance *openstackv1beta1.KeystoneService) *metav1.Condition {
	return meta.FindStatusCondition(instance.Status.Conditions, openstackv1beta1.ConditionReady)
}

func SetCondition(instance *openstackv1beta1.KeystoneService, conditionType string, status metav1.ConditionStatus, reason, message string) {
