...
const (
	readyMessage = "User in Keystone reconciled successfully"
)
...
func (r *Reporter) Pending(instance *openstackv1beta1.KeystoneUser, err error, eventReason, message string) {
	if err != nil {
...
func (r *Reporter) Succeeded(instance *openstackv1beta1.KeystoneUser) {
	r.recorder.Event(instance, corev1.EventTypeNormal, "KeystoneUserReconciled", readyMessage)
	SetCondition(instance, openstackv1beta1.ConditionReady,
		metav1.ConditionTrue, openstackv1beta1.ReasonSucceeded, readyMessage)
}

func ReadyCondition(instance *openstackv1beta1.KeystoneUser) *metav1.Condition {
	return meta.FindStatusCondition(instance.Status.Conditions, openstackv1beta1.ConditionReady)
}

func SetCondition(instance *openstackv1beta1.KeystoneUser, conditionType string, status metav1.ConditionStatus, reason, message string) {
