...
func EnsurePlacement(ctx context.Context, c client.Client, instance *openstackv1beta1.Placement, log logr.Logger) error {
	...
	if err := c.Get(ctx, client.ObjectKeyFromObject(instance), instance); err != nil {
		...
		log.Info("Creating Placement", "Name", instance.Name)
		...
		log.Info("Updating Placement", "Name", instance.Name)
