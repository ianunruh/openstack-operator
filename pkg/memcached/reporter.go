...
const (
	PendingReason = "MemcachedPending"
	RunningReason = "MemcachedRunning"
)
...
func (r *Reporter) Running(ctx context.Context) error {
	return r.reporter.UpdateReadyCondition(ctx, metav1.ConditionTrue, RunningReason, "Memcached is running")
}
