...
func LibvirtdConfigMap(instance *openstackv1beta1.NovaCompute) *corev1.ConfigMap {
...
func LibvirtdDaemonSet(instance *openstackv1beta1.NovaCompute, env []corev1.EnvVar, volumeMounts []corev1.VolumeMount, volumes []corev1.Volume) *appsv1.DaemonSet {
	labels := template.Labels(instance.Name, AppLabel, LibvirtdComponentLabel)
