...
const (
	PendingReason = "NovaCellPending"
	RunningReason = "NovaCellRunning"
)
...
func (r *Reporter) Running(ctx context.Context) error {
	return r.reporter.UpdateReadyCondition(ctx, metav1.ConditionTrue, RunningReason, "NovaCell is running")
}
