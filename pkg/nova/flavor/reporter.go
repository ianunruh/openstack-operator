...
const (
	readyMessage = "Flavor reconciled in Nova successfully"
)
...
func (r *Reporter) Pending(instance *openstackv1beta1.NovaFlavor, err error, eventReason, message string) {
	if err != nil {
...
func (r *Reporter) Deleting(instance *openstackv1beta1.NovaFlavor, err error, eventReason, message string) {
	if err != nil {
		message = fmt.Sprintf("%s: %v", message, err)
	}
...
func (r *Reporter) Succeeded(instance *openstackv1beta1.NovaFlavor) {
	r.recorder.Event(instance, corev1.EventTypeNormal, "FlavorReconciled", readyMessage)
	SetCondition(instance, openstackv1beta1.ConditionReady,
		metav1.ConditionTrue, openstackv1beta1.ReasonSucceeded, readyMessage)
}

func ReadyCondition(instance *openstackv1beta1.NovaFlavor) *metav1.Condition {
	return meta.FindStatusCondition(instance.Status.Conditions, openstackv1beta1.ConditionReady)
}

func SetCondition(instance *openstackv1beta1.NovaFlavor, conditionType string, status metav1.ConditionStatus, reason, message string) {
