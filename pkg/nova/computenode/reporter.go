...
const (
	readyMessage = "Compute node is running"
)
...
func (r *Reporter) Pending(instance *openstackv1beta1.NovaComputeNode, err error, eventReason, message string) {
	if err != nil {
...
func (r *Reporter) Running(instance *openstackv1beta1.NovaComputeNode) {
	r.recorder.Event(instance, corev1.EventTypeNormal, "ComputeNodeRunning", readyMessage)
	SetCondition(instance, openstackv1beta1.ConditionReady,
		metav1.ConditionTrue, openstackv1beta1.ReasonRunning, readyMessage)
}

func ReadyCondition(instance *openstackv1beta1.NovaComputeNode) *metav1.Condition {
	return meta.FindStatusCondition(instance.Status.Conditions, openstackv1beta1.ConditionReady)
}

func SetCondition(instance *openstackv1beta1.NovaComputeNode, conditionType string, status metav1.ConditionStatus, reason, message string) {
...
func AddReadyCheck(cw *template.ConditionWaiter, instance *openstackv1beta1.NovaComputeNode) {
