...
func NewReporter(instance *openstackv1beta1.NovaComputeSet, k8sClient client.Client, recorder record.EventRecorder) *Reporter {
	return &Reporter{
...
func (r *Reporter) Reconciled(ctx context.Context) error {
	return r.reporter.UpdateReadyCondition(ctx, metav1.ConditionTrue, openstackv1beta1.ReasonReconciled, "NovaComputeSet is reconcliled")
}
