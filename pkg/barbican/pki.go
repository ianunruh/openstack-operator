...
func PKIResources(instance *openstackv1beta1.Barbican) []*unstructured.Unstructured {
...
func APICertificate(instance *openstackv1beta1.Barbican) *unstructured.Unstructured {
