...
const (
	PendingReason = "BarbicanPending"
	RunningReason = "BarbicanRunning"
)
...
func (r *Reporter) Running(ctx context.Context) error {
	return r.reporter.UpdateReadyCondition(ctx, metav1.ConditionTrue, RunningReason, "Barbican is running")
}
