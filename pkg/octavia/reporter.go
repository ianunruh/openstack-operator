...
const (
	PendingReason = "OctaviaPending"
	RunningReason = "OctaviaRunning"
)
...
func (r *Reporter) Running(ctx context.Context) error {
	return r.reporter.UpdateReadyCondition(ctx, metav1.ConditionTrue, RunningReason, "Octavia is running")
}
