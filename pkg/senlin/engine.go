...
func EngineStatefulSet(instance *openstackv1beta1.Senlin, env []corev1.EnvVar, volumes []corev1.Volume) *appsv1.StatefulSet {
...
func EngineService(instance *openstackv1beta1.Senlin) *corev1.Service {
	labels := template.Labels(instance.Name, AppLabel, EngineComponentLabel)
